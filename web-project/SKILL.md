---
name: web-project
description: Modern web project guidance organized from Vue, Pinia, Vue Router, Vuetify, React/Next.js performance, Ant Design, Vite, pnpm, and UI/UX design skills. Use when creating, modifying, reviewing, or debugging frontend web applications, build tooling, package management, state/routing/UI framework integrations, or product interface design.
---
...
6. For `antd`, `@ant-design/pro-components`, `@ant-design/x`, Ant Design Pro, or `@ant-design/cli` work in React projects, also read `react/ant-design/SKILL.md`.
...
9. For interface design, Penpot, accessibility design, layout design, design systems, dashboards, forms, or navigation design, read `design/SKILL.md` only when the user explicitly asks for UI/UX design work or the task is primarily a design task.
